...
namespace PersonalWebSite.Controllers.ManagementPanels
{
    ...
    public class CertificatesController : Controller, IControllerFunctions<Sertifikalar>
    {
        ...
        public IActionResult Operations(Sertifikalar model) => this.AddDbExtension(_repository, model, Views.Operations.ToString());
        ...
        [ValidateAntiForgeryToken]
        [ValidateUpdateId]
        public IActionResult UpdateDb(Sertifikalar model) => this.UpdateDbExtension(_repository, model, Views.Operations.ToString());
    }
}