...
namespace PersonalWebSite.Controllers.ManagementPanels
{
    ...
    public class AccomplishmentController : Controller, IControllerFunctions<Basarilar>
    {
        ...
        public AccomplishmentController(IAccomplishmentRepository repository) => _repository = repository;
        ...
        public IActionResult Operations(Basarilar model) => this.AddDbExtension(_repository, model, Views.Operations.ToString());
        ...
        [ValidateAntiForgeryToken]
        [ValidateUpdateId]
        public IActionResult UpdateDb(Basarilar model) => this.UpdateDbExtension(_repository, model, Views.Operations.ToString());
    }
}